...
def fix_yaw(des_pos):
    ...
    """
    global yaw_, pub, yaw_precision_2_, state_, desired_position_
...
def go_to_point(goal):
    ...
    #desired_position_.theta = goal.theta
    state_ = 0
    rate = rospy.Rate(5)
    success = True

    feedback = erl2.msg.TargetFeedback()
    result = erl2.msg.TargetResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/go_to_point', erl2.msg.TargetAction, go_to_point, auto_start=False)
    act_s.start()
