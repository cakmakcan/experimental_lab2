...
from erl2.srv import HypCheck, HypCheckResponse
...
def check_complete(req):
    ...
    print("Server Complete Hypotheses:", complete_hyp)
    return HypCheckResponse(complete_hyp)
...
def main():
    ...
    check_comp_service = rospy.Service('/check_hyp_complete', HypCheck, check_complete)
